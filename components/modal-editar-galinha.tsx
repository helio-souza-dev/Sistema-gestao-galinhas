...
interface ModalEditarGalinhaProps {
  galinha: Galinha | null
  aberto: boolean
  onClose: () => void
  onSave: (id: string, updates: any) => Promise<{ success: boolean; error?: string }>
}

export function ModalEditarGalinha({ galinha, aberto, onClose, onSave }: ModalEditarGalinhaProps) {
